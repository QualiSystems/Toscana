...
")
        ...
        [Test]
        public void Shell_With_Empty_Based_On_Property_Is_Parsed_Successfully_And_Returns_Empty()
        {
            // Arrange
            fileSystem.CreateArchive(
                "tosca.zip",
...
")
            ...
            // Assert
            toscaCloudServiceArchive.ToscaServiceTemplates.First().Value.Metadata.TemplateBasedOn.Should().Be("");
        }
