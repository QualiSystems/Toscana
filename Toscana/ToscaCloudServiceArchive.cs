...
Examples of valid values for an “type” of “Linux” would include:  debian, fedora, rhel and ubuntu.";
        ...
        {
            var cloudServiceArchiveSaver = DependencyResolver.GetToscaCloudServiceArchiveSaver();
        ...
        {
            var toscaCloudServiceArchiveSaver = DependencyResolver.GetToscaCloudServiceArchiveSaver();
        ...
        {
            return DependencyResolver.GetToscaCloudServiceArchiveLoader();
        }
